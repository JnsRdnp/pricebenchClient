...
export default function GiganttiPCs() {
  ...
  return (
    <div className="container">
        ...
        className="mb-4"
        style={{
            lineHeight: '1.2',      // bigger than default if needed
            paddingBottom: '4px',  // extra space at bottom
            fontSize: '1.8rem',
            fontWeight: '700',
      ...
      <div className="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4">
        {products.map((product) => (
            <div className="col" key={product.id} style={{ maxWidth: '320px' }}>
            <a
                href={product.link}
                target="_blank"
            ...
            >
                ...
                <img
                    ...
                    alt={product.name}
                    style={{ objectFit: 'contain', height: '140px', backgroundColor: '#f0f0f0' }}
                />
